...
export class NotAuthorizedError extends CustomError {
  ...
  constructor() {
    super("Not authorized"); // constructor dari derived class harus panggil constructor dari parent classny dulu (super()), biar galo galo properti dari parent classny dituruni ke class ini
